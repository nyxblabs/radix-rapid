...
import { NODE_TYPES, createRouter } from '../src'
...
describe('Router lookup', () => {
   ...
   describe('retrieve placeholders', () => {
      testRouter(
         [
            'carbon/:element',
   ...
   describe('should be able to match routes with trailing slash', () => {
...
describe('Router insert', () => {
   ...
   it('should insert static routes into the static route map', () => {
      const router = createRouter()
   ...
   it('should not insert variable routes into the static route map', () => {
      const router = createRouter()
      const routeA = '/api/v2/**'
   ...
   it('should insert placeholder and wildcard nodes correctly into the tree', () => {
      const router = createRouter()
   ...
   it('should be able to initialize routes via the router contructor', () => {
      const router = createRouter({
         routes: {
            '/api/v1': { value: 1 },
            '/api/v2': { value: 2 },
   ...
   it('should allow routes to be overwritten by performing another insert', () => {
      const router = createRouter({
...
describe('Router remove', () => {
   ...
   it('should be able to remove placeholder routes', () => {
      const router = createRouter({
   ...
   it('should be able to remove wildcard routes', () => {
      const router = createRouter({
   ...
   it('should return a result signifying that the remove operation was successful or not', () => {
      const router = createRouter({
